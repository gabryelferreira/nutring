        ...
        return (
            <>
                ...
                <Animated.View style={{width: imageWidth, height: testeHeight, position: 'absolute', left: 0, right: 0, top: 0, zIndex: 1, backgroundColor: 'rgba(0, 0, 0, .2)'}}>
                    ...
                    <Image resizeMethod="resize" style={{flex: 1, width: undefined, height: undefined, zIndex: 2}} source={this.props.image ? {uri: this.props.image} : require('../../assets/imgs/what_a_promocao.jpg')}/>
                </Animated.View>
